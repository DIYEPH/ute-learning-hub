...
export function EditDocumentFileModal({ open, onOpenChange, documentId, file, onSuccess }: EditDocumentFileModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await putApiDocumentByDocumentIdFilesByFileId({
                ...
                body: { title: title.trim() || undefined, order: file.order ?? undefined }
            });
            ...
            <DialogContent className="max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input id="file-title" value={title} onChange={e => setTitle(e.target.value)} placeholder="Nhập tiêu đề" />
                    </div>
