...
public static class TrustScoreConstants
{
    ...
    public const int TrustedMemberDailyReportLimit = 3;  // TrustedMember trở lên chỉ được báo cáo + duyệt tự động 3 lần/ngày, từ lần thứ 4 sẽ vào pending như người bình thường (cần admin duyệt, đúng thì mới có thưởng)
